...
public class DataCheck {
    ...
    private int phone;
    private GenderException.Gender gender;
    ...
    private GenderException.Gender checkGender(String inputString) throws GenderException {
        try {
            return GenderException.Gender.valueOf(inputString);
